  ...
  function Cansf(canvas) {
    ...
    this.drawText = function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3(text, x, y) {
        ...
        var _props$color, color, _props$fontSize, fontSize, _props$fontWeight, fontWeight, _props$fontStyle, fontStyle, _props$letterSpacing, letterSpacing, width, _props$textAlign, textAlign, _props$hasBreak, hasBreak, lineHeight, shadow, callback, i;

        return _regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _props$color = props.color, color = _props$color === undefined ? '#000' : _props$color, _props$fontSize = props.fontSize, fontSize = _props$fontSize === undefined ? '10px' : _props$fontSize, _props$fontWeight = props.fontWeight, fontWeight = _props$fontWeight === undefined ? '' : _props$fontWeight, _props$fontStyle = props.fontStyle, fontStyle = _props$fontStyle === undefined ? '' : _props$fontStyle, _props$letterSpacing = props.letterSpacing, letterSpacing = _props$letterSpacing === undefined ? '' : _props$letterSpacing, width = props.width, _props$textAlign = props.textAlign, textAlign = _props$textAlign === undefined ? 'left' : _props$textAlign, _props$hasBreak = props.hasBreak, hasBreak = _props$hasBreak === undefined ? false : _props$hasBreak, lineHeight = props.lineHeight, shadow = props.shadow, callback = props.callback;
              ...
              case 15:
                ...
                _context3.next = _context3.t0 === 'right' ? 20 : _context3.t0 === 'center' ? 22 : 24;
                break;
...
var Cans = function (_Cansf) {
  ...
  function Cans(canvas) {
    ...
    var _this = _possibleConstructorReturn(this, (Cans.__proto__ || Object.getPrototypeOf(Cans)).call(this, canvas));
            ...
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                return Promise.all(images.map(function (v) {
                  return _this3.getCache(v.source);
                }));
