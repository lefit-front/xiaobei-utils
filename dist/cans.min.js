  ...
  _createClass(Cans, [{
    ...
    value: function resolveLines() {
      ...
      lines.forEach(function (v) {
        _this2.drawLine(v.sx, v.sy, v.ex, v.ey, v.lineWidth, v.color, v.style, v.shadow, v.callback);
      });
    }
  }, {
    key: 'resolveTexts',
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                ...
                // 下面虽然异步 但实际执行的同步代码
                res.map(function () {
                  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(img, index) {
                    var _images$index, x, y, width, height, border, shadow, borderRadius, callback;
                    ...
                    return _regeneratorRuntime.wrap(function _callee2$(_context2) {
                      while (1) {
                        switch (_context2.prev = _context2.next) {
                          ...
                          case 3:
                            _images$index = images[index], x = _images$index.x, y = _images$index.y, width = _images$index.width, height = _images$index.height, border = _images$index.border, shadow = _images$index.shadow, borderRadius = _images$index.borderRadius, callback = _images$index.callback;
                            _context2.next = 6;
